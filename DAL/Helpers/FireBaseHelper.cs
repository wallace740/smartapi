...
namespace DAL.Helpers
{
    public class FireBaseHelper
    {
        ...
        {
            AuthSecret = FireBaseConstants.AuthSecret, //"Rx3tQecme7D9HCmEthw1y4O2qlD08bfLuYJFjWPk",
            BasePath = FireBaseConstants.BasePath   //"https://aromanatural740-default-rtdb.firebaseio.com/"
        };
        ...
        {
            var data = updateItem;
            SetResponse setResponse = Client.Set(TableName + "/" + data.Id, data); //Students
            if (setResponse.StatusCode == HttpStatusCode.OK)
            {
